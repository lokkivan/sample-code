...
$title = 'Удаление все видео с сайта:' . $site->domain_name;
$menu = [
    [
...
@section('content')
    <div class="container">
        ...
        {!! Form::open(['url' => route('delete_all_video_from_site', ['site' => $site]), 'method' => 'delete']) !!}
        <div class="form-group">
            {!! Form::label('', 'Вы действительно хотите удалить все видео с этого сайта?') !!}
            <div>
